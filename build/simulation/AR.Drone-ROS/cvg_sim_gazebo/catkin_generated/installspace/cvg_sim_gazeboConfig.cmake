...
if("FALSE" STREQUAL "TRUE")
  set(cvg_sim_gazebo_SOURCE_PREFIX /home/hammerviking/robotic_software/ardrone_moving_landing_platform/src/simulation/AR.Drone-ROS/cvg_sim_gazebo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cvg_sim_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hammerviking/robotic_software/ardrone_moving_landing_platform/install/${idir}'.  ${_report}")
    endif()
